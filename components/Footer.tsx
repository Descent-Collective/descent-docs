...
import { DescentLogo } from "../components/Logo";
...
export const Footer = () => {
  ...
  const LINKS = {
    ...
    resources: [
      { text: "About", path: "https://descentdao.com/about" },
      { text: "Blog", path: "https://descentdao.mirror.xyz" },
    ],
    docs: [
      { text: "Descent Protocol", path: "/" },
      { text: "Descent SDK", path: "/library" },
    ],
    social: [
      {
        text: "Twitter",
        path: "https://twitter.com/descentdao",
        icon: TwitterIcon,
      },
      {
        text: "Instagram",
        path: "https://www.instagram.com/descentdao",
        icon: InstagramIcon,
      },
      {
        text: "Discord",
        path: "https://discord.gg/descentdao",
        icon: DiscordIcon,
      },
      {
        text: "Mirror",
        path: "https://descentdao.mirror.xyz",
        icon: MirrorIcon,
      },
    ],
  };
  ...
  return (
    <>
      <SectionContainer
        css={{ backgroundColor: colorMode === "dark" ? "$darkBg" : "white" }}
      >
        <InnerContainer
          css={{ color: colorMode === "white" ? "white" : "$neutral900" }}
        >
          <Section
            css={{
              display: "flex",
...
const MirrorIcon = () => (
  ...
  >
    <path
      d="M7 13C7 8.58172 10.5817 5 15 5C19.4183 5 23 8.58172 23 13V25H7V13Z"
      fill="#A3A3A3"
    />
  </svg>
);
