...
#### Governors
* **$DSN Holders** - These are actors that hold the $DSN protocol token and have advanced to extensive knowledge of the protocol. They monitor, partake, and vote on upgrades/changes to the Descent protocol.
