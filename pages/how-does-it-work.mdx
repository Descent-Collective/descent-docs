Descent protocol works by allowing people borrow Naira stablecoins against any collateral asset.
...
Inside the Descent ecosystem, the native $OSN token allows token holders to influence certain aspects of the protocol such as:
